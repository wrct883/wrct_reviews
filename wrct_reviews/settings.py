"""
Django settings for wrct_reviews project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-lhprnbuz!kyd48edt$yp%sj-80cdx+zykd0jpu-(9qm(a@_$_a')
...
WSGI_APPLICATION = 'wrct_reviews.wsgi.application'
